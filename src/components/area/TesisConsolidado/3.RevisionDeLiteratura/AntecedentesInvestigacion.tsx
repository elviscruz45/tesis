...
// export default function AntecedentesInvestigacion({
//   open,
//   setOpen,
//   contentData,
//   sectionName,
...
//       <div className="text-xl">2.1. Antecedentes de la Investigación</div>
//       <div className="text-xl">2.2. Marco Teórico</div>
//       <div className="text-xl">2.3. Desarrollo de las Hipótesis</div>
//     </>
//   );
// }
