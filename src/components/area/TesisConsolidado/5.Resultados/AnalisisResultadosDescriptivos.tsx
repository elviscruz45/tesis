...
export default function AnalisisResultadosDescriptivos({
  open,
  setOpen,
  contentData,
  sectionName,
  ...
  return (
    <>
      ...
      <div className="text-xl">4.1. Resultados demográficos </div>
      <div className="text-xl">4.2. Análisis de resultados descriptivos</div>
      <div className="text-xl">4.3. Prueba de hipótesis</div>
      <div className="text-xl">4.4. Pruebas adicionales </div>
    </>
  );
}
