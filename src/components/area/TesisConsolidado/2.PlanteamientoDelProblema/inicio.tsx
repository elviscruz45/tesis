...
import LineaDeInvestigacion from "./LineaDeInvestigacion";
import DescripcionDelProblema from "./DescripcionDelProblema";
import PreguntasDeInvestigacion from "./PreguntasDeInvestigacion";
import ObjetivosDeProyecto from "./ObjetivosDeProyecto";
import JustificacionDeLaInvestigacion from "./JustificacionInvestigacion";
import Delimitaciones from "./Delimitaciones";
