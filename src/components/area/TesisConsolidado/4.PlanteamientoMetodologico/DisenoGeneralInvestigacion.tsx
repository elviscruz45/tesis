...
// export default function DisenoGeneralInvestigacion({
//   open,
//   setOpen,
//   contentData,
//   sectionName,
...
//       <div className="text-xl">3.1. Diseño General de la Investigación</div>
//       <div className="text-xl">3.2. Unidades de Análisis</div>
//       <div className="text-xl">3.3. Variables</div>
//       <div className="text-xl">3.4. Medición de las Variables</div>
//       <div className="text-xl">3.5. Métodos para el análisis de datos</div>
//     </>
//   );
// }
