...
export const ChatGPTDedicatoria = ({ titulo, userId, seccion }: any) => {
      ...
      const userAssitantMessage: any = [
        {
          role: "user",
          content: `
          1.Redacta en primera persona una dedicatoria de tesis incluye la carrera en la que se esta graduando ${carrera}. (1 párrafo de 2 lineas )
    ...
    <div className=" items-start text-xl">
      <div className="rounded-md  bg-slate-300 p-6 shadow-md">
        <ul className="list-inside list-disc space-y-2 text-gray-700">
          <li>
            Dedicatoria simple de tesis (1 párrafo muy breve de dos líneas)
          </li>
          <li>
