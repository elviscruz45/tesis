...
import { ChatGPTTecnicaMuestreo } from "./ChatGPTTecnicaMuestreo";
...
export default async function RetrieveTecnicaMuestreo({
  open,
  setOpen,
  contentData,
  sectionName,
  ...
  return (
    <>
      ...
      <br />
      <ChatGPTTecnicaMuestreo
        titulo={titulo?.title}
        poblacion={poblacion?.title}
        userId={userId}
        seccion={"Tecnicas de Muestreo"}
      />
    </>
  );
}
