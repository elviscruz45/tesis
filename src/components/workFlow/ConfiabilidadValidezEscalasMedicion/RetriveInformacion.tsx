...
import { ChatGPTConfiabilidadValidezEscalasMedicion } from "./ChatGPTConfiabilidadValidezEscalasMedicion";
...
export default async function RetrieveConceptualizacionVariables({
  ...
  return (
    <>
      ...
      <br />
      <ChatGPTConfiabilidadValidezEscalasMedicion
        titulo={titulo?.title}
        poblacion={poblacion?.title}
        userId={userId}
        seccion={"Operacionalizacion de las Variables"}
      />
    </>
  );
}
