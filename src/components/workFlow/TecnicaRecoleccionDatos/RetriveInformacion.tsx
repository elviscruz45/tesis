...
import { ChatGPTTecnicaRecoleccionDatos } from "./ChatGPTTecnicaRecoleccionDatos";
...
export default async function RetrieveViabilidad({
  open,
  setOpen,
  contentData,
  sectionName,
  ...
  return (
    <>
      ...
      <br />
      <ChatGPTTecnicaRecoleccionDatos
        titulo={titulo?.title}
